...
cols<-c('caseid',
        'weight',
        'cdid112_10','countyfips_10','cdid114_14','countyfips_14',
        'CC10_315a','CC14_315a',
        'CC10_390','CC14_390','CC14_390b'
        )

cces<-cces %>% 
  select(any_of(cols)) %>% 
  mutate(`CC14_390`=ifelse(is.na(`CC14_390`),`CC14_390b`,`CC14_390`),
...
cces<-cces %>% 
  mutate(ccesdistrict=paste0(str_sub(countyfips,1,2),cdid)) %>% 
